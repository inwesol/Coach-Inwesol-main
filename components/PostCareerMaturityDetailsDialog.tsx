      ...
      <DialogContent className='max-h-[90vh] max-w-5xl overflow-y-auto'>
        ...
        {postCareerMaturityData && !loading && (
          <div className='space-y-6'>
              ...
              <CardContent className='space-y-4'>
                <div className='grid grid-cols-1 gap-4 md:grid-cols-3'>
                  <div>
                    ...
                    <p className='text-lg'>
                      {postCareerMaturityData.session_id}
                    </p>
                  </div>
                  <div>
                    <label className='text-sm font-medium text-muted-foreground'>
                  ...
                  {postCareerMaturityData.score !== undefined &&
                    postCareerMaturityData.score !== null && (
                      <div>
                        <label className='text-sm font-medium text-muted-foreground'>
                          Overall Score
                        </label>
                        <div className='mt-1'>
                          <span
                            className={`text-2xl font-bold ${getScoreLevel(postCareerMaturityData.score).color}`}
                          >
                            {postCareerMaturityData.score}
                          </span>
            ...
            {/* Subscale Scores */}
            {postCareerMaturityData.subscale_scores &&
              Object.keys(postCareerMaturityData.subscale_scores).length >
                0 && (
                <Card>
                  <CardHeader>
                    <CardTitle className='flex items-center gap-2'>
