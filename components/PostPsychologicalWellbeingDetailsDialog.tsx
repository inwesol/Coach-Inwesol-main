              ...
              <CardContent className='space-y-4'>
                <div className='grid grid-cols-1 gap-4 md:grid-cols-3'>
                  <div>
                    ...
                    <p className='text-lg'>
                      {postPsychologicalWellbeingData.session_id}
                    </p>
                  </div>
                  <div>
                    <label className='text-sm font-medium text-muted-foreground'>
                  ...
                  <div>
                    ...
                    <div className='mt-1'>
                      <span
                        className={`text-2xl font-bold ${getScoreLevel(parseFloat(postPsychologicalWellbeingData.score)).color}`}
                      >
                        {postPsychologicalWellbeingData.score}
                      </span>
